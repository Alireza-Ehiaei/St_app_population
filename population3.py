...
""")
#url = (r"http://raw.githubusercontent.com/Alireza-Ehiaei/St_app_population/blob/main/hugh-whyte-J8bU6-tAGy8-unsplash.jpg")
#response = requests.get(url)
#image = Image.open(BytesIO(response.content))
htp = Image.open("hugh-whyte-J8bU6-tAGy8-unsplash.jpg")
st.image(htp, use_column_width=True, caption='Photo by Hugh Whyte on Unsplash')
...
#url = (r"http://raw.githubusercontent.com/Alireza-Ehiaei/St_app_population/blob/main/Photo_by_Ishan_%40seefromthesky_on_Unsplash.jpg")
#response = requests.get(url)
#image = Image.open(BytesIO(response.content))
...
if (selected_topic == 'Population'):
      ...
      df = pd.read_csv(r"https://raw.githubusercontent.com/Alireza-Ehiaei/St_app_population/blob/main/WPP2019_POP_F01_1_TOTAL_POPULATION_BOTH_SEXES.csv", header=[0], encoding='latin-1')
...
#################################################### Population Growth Rate ###################################################
          ...
          df = pd.read_csv(r"https://raw.githubusercontent.com/Alireza-Ehiaei/St_app_population/main/WPP2019_POP_F02_POPULATION_GROWTH_RATE.csv", header=[0], encoding='latin-1')
          df.columns = df.columns.astype(str)
          df = df.rename(columns = {'Region, subregion, country or area':'country'})
...
#################################################### Median Age of Population ###################################################
          ...
          df = pd.read_csv(r"https://raw.githubusercontent.com/Alireza-Ehiaei/St_app_population/main/WPP2019_POP_F05_MEDIAN_AGE.csv", header=[0], encoding='latin-1')
...
#################################################### Population  Density ###################################################
          ...
          df = pd.read_csv(r"https://raw.githubusercontent.com/Alireza-Ehiaei/St_app_population/main/WPP2019_POP_F06_POPULATION_DENSITY.csv", header=[0], encoding='latin-1')
...
#################################################### population by age groupe ###################################################
          ...
          df = pd.read_csv(r"https://raw.githubusercontent.com/Alireza-Ehiaei/St_app_population/main/WPP2019_POP_F09_1_PERCENTAGE_OF_TOTAL_POPULATION_BY_BROAD_AGE_GROUP_BOTH_SEXES.csv", header=[0], encoding='latin-1')
